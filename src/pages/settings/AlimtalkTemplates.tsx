  ...
  const columns: ColumnsType<AlimtalkTemplate> = [
    ...
    },
    {
      ...
      render: (status: string) => (
        <Tag color={reviewStatusColor[status]}>{reviewStatusText[status]}</Tag>
      ),
    },
    {
      title: '활성화',
          ...
          <div>
            <Descriptions bordered column={1} size="small">
              ...
              <Descriptions.Item label="솔라피 템플릿 ID">
                <span style={{ fontFamily: 'monospace', fontSize: '12px' }}>{selectedTemplate.templateId}</span>
              </Descriptions.Item>
              ...
              <Card title="알림톡 버튼" style={{ marginTop: '16px' }} size="small">
                {selectedTemplate.buttons.map((button, index) => (
                  <Card
                    ...
                    size="small"
                    style={{ marginBottom: index < selectedTemplate.buttons.length - 1 ? '8px' : 0 }}
                  >
                    <Descriptions column={1} size="small">
                      ...
                      {button.linkAnd && (
                        <Descriptions.Item label="Android 스킴">{button.linkAnd}</Descriptions.Item>
                      )}
