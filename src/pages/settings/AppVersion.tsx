...
const AppVersion: React.FC = () => {
  const { versions, loading, error, refetch, pagination, onPageChange, modal, handleDelete, handleToggleActive } =
    useAppVersionCrud();
  ...
  return (
    <div>
      <PageHeading
        title="앱 버전 관리"
        description="최소 요구 버전 미만은 필수 업데이트, 그 이상에서 최신 버전 미만은 권장 업데이트를 안내합니다. 플랫폼별 가장 최근에 생성된 활성 설정이 적용됩니다."
        action={
