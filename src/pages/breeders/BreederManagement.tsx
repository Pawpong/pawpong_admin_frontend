    ...
    <div className="p-3 sm:p-4 md:p-6">
      ...
      >
        ...
        <div className="p-4 rounded mb-4" style={{ backgroundColor: '#fef3c7', borderLeft: '4px solid #f59e0b' }}>
          ...
          <div className="p-3 rounded text-sm" style={{ backgroundColor: '#fffbeb', border: '1px solid #fde68a' }}>
...
감사합니다.`}
        ...
        <div className="p-3 rounded" style={{ backgroundColor: '#dbeafe', borderLeft: '3px solid #3b82f6' }}>
