...
interface ProfileBannerTableProps {
 ...
 * 프로필 배너 테이블 컴포넌트
 */
export function ProfileBannerTable({ banners, loading, onEdit, onDelete, onToggleActive }: ProfileBannerTableProps) {
