import { Table, Image, Space, Button, Switch, Tag, Popconfirm } from 'antd';
 ...
 * 메인 배너 테이블 컴포넌트
 */
export function BannerTable({ banners, loading, onEdit, onDelete, onToggleActive }: BannerTableProps) {
